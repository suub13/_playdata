...
public class ObjectStreamExample {
    ...
    public static void writeList() throws Exception{
        ...
        FileOutputStream fos = new FileOutputStream("C:/codes/java/exception/out/production/exception/board.db");
    ...
    public static List<Board> readList() throws Exception{
        FileInputStream fis = new FileInputStream("C:/codes/java/exception/out/production/exception/board.db");
